...
$country_codes = array("AF" => "Afghanistan",
                       "AX" => "Åland islands",
                       "AL" => "Albania",
                       "DZ" => "Algeria",
                       "AS" => "American Samoa",
...
$timezone_strings = array("Africa/Abidjan" => "Africa/Abidjan",
...
if(!empty($s->identifiers)) {
    ...
    $t->assign('others', &$others);
}

$t->caching = false;
$t->display('settings.tpl');
exit;
?>
